packages <- c(
  ...
  "gridExtra",
  "RColorBrewer",
  "xlsx", # Requires Java Runtime (64-bit)!
  "zip"
)
...
ref_data <- file.path(getwd(), "Reference Data")

con_str <- sprintf(
  "Driver={%s};Server={%s};Database={%s};Uid={%s};Pwd={%s};",
  "SQL Server", "192.168.1.32", Project_Database, "ruser", "Th!nkruser"
)

con <- RODBC::odbcDriverConnect(connection=con_str)

if (con == -1L) message("WARNING: Database not connected.")
