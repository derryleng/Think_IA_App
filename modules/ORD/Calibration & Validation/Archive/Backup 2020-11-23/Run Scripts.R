...
Project_Directory <- file.path(Root_Dir[2], User_Dir[1], Proj_Dir[1]) # Select the correct index numbers!
...
# Name of output folder in project directory ---------------------------- #
outdir_parameter_summary <- "Adaptation - Sprint 14 - IA-187 v1 DL"
...
adaptation_folder <- "Adaptation - Sprint 15 v1"
...
# Name of output folder in project directory ---------------------------- #
outdir_validation_analysis <- "Validation - VALR DBS"
