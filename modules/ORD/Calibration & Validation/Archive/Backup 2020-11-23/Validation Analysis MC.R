...
sep_adjust <- fread(file.path(Project_Directory, sep_adjust_file))
...
adaptation <- as.data.frame(list("Validation_Set" = val,
                                 ...
                                 "sep_adjust_file" = sep_adjust_file,
                                 "egll_mean" = egll_mean,
                                 "egll_sd" = egll_sd,
                                 "pc_under" = pc_under))
...
qile_all <- quantile(original_data2$Modelled_Thresh_Accuracy_Rounded, 0.001 / operational_hour_multiplier_all) + 0.05
qile_wake <- quantile(filter(original_data2, RECAT_Wake == "RECAT Wake")$Modelled_Thresh_Accuracy_Rounded, 0.001 / operational_hour_multiplier_all) + 0.05
