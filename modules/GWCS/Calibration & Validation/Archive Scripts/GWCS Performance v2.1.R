...
version <- "v2.0 22.03.21 January and February Data"
# user <- "Catherine"
#user <- "George Clark"
#user <- "Michael Cowham"
user <-  "Andy Hyde"
...
prop_str <-  paste("C:\\Users\\", user, "\\Dropbox (Think Research)\\NATS Projects\\NATS NavCanada TBS\\Data Analysis\\Outputs\\Sample_Weighting_Output\\v2.3 22.03.21\\Wake Pair Proportions.csv", sep = "")
prop <- fread(prop_str)

#Arrival totals - update folder name
arr_str <- paste("C:\\Users\\", user, "\\Dropbox (Think Research)\\NATS Projects\\NATS NavCanada TBS\\Data Analysis\\Outputs\\Sample_Weighting_Output\\v2.3 22.03.21\\Arrival Totals.csv", sep = "")
arr <- fread(arr_str)
