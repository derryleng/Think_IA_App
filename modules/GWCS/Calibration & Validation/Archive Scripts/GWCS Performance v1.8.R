...
version <- "v1.8 26.01.21 2_month_set MC"
#user <- "Catherine"
#user <- "George Clark"
user <- "Michael Cowham"
...
# Input - Update
input <- paste0("C:\\Users\\", user, "\\Dropbox (Think Research)\\NATS Projects\\NATS NavCanada TBS\\Data Analysis\\Inputs\\GWCS_Input\\25.01.2021_2_Month_dataset")
