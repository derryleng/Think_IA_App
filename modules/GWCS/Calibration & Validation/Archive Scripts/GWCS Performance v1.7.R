...
version <- "v1.7 13.01.21 2_month_set MC"
#user <- "Catherine"
#user <- "George Clark"
user <- "Michael Cowham"
...
# Input - Update
input <- paste0("C:\\Users\\", user, "\\Dropbox (Think Research)\\NATS Projects\\NATS NavCanada TBS\\Data Analysis\\Inputs\\GWCS_Input\\13.01.2021_2_Month_dataset")
...
prop_str <-  paste("C:\\Users\\", user, "\\Dropbox (Think Research)\\NATS Projects\\NATS NavCanada TBS\\Data Analysis\\Outputs\\Sample_Weighting_Output\\v2.1 13.01.21\\Wake Pair Proportions.csv", sep = "")
prop <- fread(prop_str)

#Arrival totals - update folder name
arr_str <- paste("C:\\Users\\", user, "\\Dropbox (Think Research)\\NATS Projects\\NATS NavCanada TBS\\Data Analysis\\Outputs\\Sample_Weighting_Output\\v2.1 13.01.21\\Arrival Totals.csv", sep = "")
arr <- fread(arr_str)
...
# mean(usable_flight$`Non-Stale Count`)
# 
# # data_loss <- c("2020-08-15",
# #                "2020-08-16",
# #                "2020-08-19",
# #                "2020-08-21",
# #                "2020-08-24",
...
# #                "2020-10-31"
# # )
# # usable_flight_data_loss_remove <- usable_flight[!(as.character(usable_flight$FP_Date) %in% data_loss),]
# # mean(usable_flight_data_loss_remove$`Non-Stale Count`)
